...
export function Input({
  ...
  return (
    <div className={cn("space-y-2", containerClassName)}>
      ...
      <div
        className={cn(
          "flex h-11 items-center gap-2 rounded-[10px] border border-border bg-surface-card px-3.5 text-base text-text-primary transition-[border-color,box-shadow] duration-150 focus-within:border-brand-blue focus-within:shadow-focus",
          error
